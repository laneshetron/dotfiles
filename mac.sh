...
## Application setup
BREW_PKGS=(aircrack-ng autoconf automake cmake curl gdb git go gpg htop kafka knock kubernetes-cli nmap node pkg-config protobuf pypy3 python3 redis spoof-mac the_silver_searcher terraform tmux unrar watch wget zstd)
