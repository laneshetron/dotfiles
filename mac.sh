...
## Application setup
BREW_PKGS=(aircrack-ng autoconf automake cmake curl gdb git go gpg htop kafka knock nmap node protobuf pypy3 python3 redis spoof-mac the_silver_searcher tmux unrar watch wget zstd)
